 ...
 * Add nil type
 * 2011/06/21 : Modification by Celine Boudier : cboudier@aldebaran-robotics.com
 * Added float type
 */
...
class XMLRPCSerializer implements IXMLRPCSerializer {
	...
	public void serialize(XmlSerializer serializer, Object object) throws IOException {
		...
		if (object instanceof Float ) {
			serializer.startTag(null, TYPE_FLOAT).text(object.toString()).endTag(null, TYPE_FLOAT);
		} else
	...
	public Object deserialize(XmlPullParser parser) throws XmlPullParserException, IOException {
		...
		if (hasType) {
			...
			if (typeNodeName.equals(TYPE_FLOAT)) {
				String value = parser.nextText();
